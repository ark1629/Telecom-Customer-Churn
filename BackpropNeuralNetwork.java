...
public class BackpropNeuralNetwork {
     ...
     */
    public BackpropNeuralNetwork(int inputNodeCount, int hiddenNodeCount, int outputNodeCount, float learningRate) {
        
        this(inputNodeCount, hiddenNodeCount, outputNodeCount, learningRate, null);
    }
    ...
    public void ausgabeGewichte(){
        System.out.print("Gewichte IH:");
        for (int i=0; i<inputNodeCount;i++){
            for (int j = 0; j < hiddenNodeCount; j++) {
                System.out.print(weightsIH[i][j]+" - ");
            }
        }

        for (int i = 0; i < hiddenNodeCount; i++) {
            System.out.print(" Bias Hiddennodes:"+biasH[i]);
        }
        System.out.println();
        System.out.print("Gewichte HO:");
        for (int i=0; i<hiddenNodeCount;i++){
            for (int j = 0; j < outputNodeCount; j++) {
                System.out.print(weightsHO[i][j]+" - ");
            }
        }
        for (int i = 0; i < outputNodeCount; i++) {
            System.out.print(" Bias Outputnodes:"+biasO[i]);
        }
         System.out.println();        
    }
    /**
    ...
    public double[] forwardPass(double[] inputs) {
        ...
        for (int i = 0; i < hiddenNodeCount; i++) {
            ...
            //ReLU
            if (activation>0){
                hiddenNodeOutputs[i] = activation;
            }
            else hiddenNodeOutputs[i] = 0;
